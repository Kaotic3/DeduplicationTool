...
namespace DeduplicationTool.Models
{
    public class MovePDFPages
    {
        ...
        public async Task<byte[]> MoveOnText(MemoryStream pdfFile)
        {
            SHA256 sha256 = SHA256.Create();
            HashSet<string> pages = new HashSet<string>();
            List<int> pagesToCopy = new List<int>();
            ...
            try
            {
                using (var pdfIn = new PdfDocument(new PdfReader(pdfFile)))
                {
                    using (var pdfOut = new PdfDocument(new PdfWriter(outstream)))
                    {
                        ...
                        int pageCount = pdfIn.GetNumberOfPages();
        ...
        public async Task<byte[]> MoveOnImages(MemoryStream pdfFile)
        {
            SHA256 sha256 = SHA256.Create();
            HashSet<string> pages = new HashSet<string>();
            List<int> pagesToCopy = new List<int>();
            ...
            /// <param name="filename"></param>
            /// <returns></returns>
        public async Task<byte[]> MoveRepaginateImages(MemoryStream pdfFile)
        {
            SHA256 sha256 = SHA256.Create();
            HashSet<string> pages = new HashSet<string>();
            List<int> pagesToCopy = new List<int>();
