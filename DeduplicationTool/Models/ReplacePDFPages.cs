...
namespace DeduplicationTool.Models
{
    public class ReplacePDFPages
    {
        ...
        public async Task<byte[]> ReplaceOnText(MemoryStream pdfFile, string placeHolder)
        {
            SHA256 sha256 = SHA256.Create();
            HashSet<string> pages = new HashSet<string>();
            List<int> pagesToCopy = new List<int>();
        ...
        public async Task<byte[]> ReplaceOnImages(MemoryStream pdfFile, string placeHolder)
        {
            SHA256 sha256 = SHA256.Create();
            HashSet<string> pages = new HashSet<string>();
            List<int> pagesToCopy = new List<int>();
